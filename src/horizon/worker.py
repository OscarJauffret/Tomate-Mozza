...
class Worker(multiprocessing.Process):
    def __init__(self, server_id, choose_map_event, print_state_event, save_model_event, queue, model_path=None):
        super().__init__()
        self.server_id = server_id
        self.client = HorizonClient(self.server_id, queue, model_path)
